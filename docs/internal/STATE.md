...
| **Phase 3 — Validation & pipeline** | 🟡 En cours | Task 30 ✅ — Validators stricts (SURPRISED guard, action budget, friendly fire, range zones, validate_move_in_combat) ; Task 31 ✅ — dispatch pipeline combat-aware + MOVE→FLEE auto-convert ; Task 32 (résolveur FLEE) à venir |
